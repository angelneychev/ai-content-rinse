...
function aicr_assets( $hook ) {
	...
	wp_enqueue_style( 'aicr-admin', plugins_url( 'assets/admin.css', __FILE__ ), array(), '0.3.1' );
	wp_enqueue_script( 'aicr-admin', plugins_url( 'assets/admin.js', __FILE__ ), array( 'wp-i18n' ), '0.3.1', true );
...
function aicr_page() {
	?>
	<div class="wrap aicr">
		<header><span class="aicr-eyebrow">AI CONTENT RINSE / 0.3.1</span><h1><?php esc_html_e( 'A cleaner start for your content.', 'ai-content-rinse' ); ?></h1>
		<p><?php esc_html_e( 'Review text changes. Clean image metadata. Verify the result.', 'ai-content-rinse' ); ?></p></header>
